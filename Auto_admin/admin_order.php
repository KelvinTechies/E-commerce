   ...
   <main>
                <div class="vd jd tto vv oq ar ri">
                    ...
                    <div class="_y js jn ry">
                        ...
                        <!-- Left: Title -->
                        <div class="rw _a">
                            <h1 class="gg zj text-slate-800 font-bold">Orders ✨</h1>
                        </div>
                        ...
                        <div class="sq fa _j fm ji fy">
                            ...
                            <div class="td" x-data="{ open: false, selected: 2 }">
                                <button class="btn fg uj bg-white border-slate-200 hover--border-slate-300 text-slate-500 hover--text-slate-600"
                                ...
                                <div class="nv tp tq tw oq bg-white border border-slate-200 ms rounded by lq iu" @click.outside="open = false"
                                    @keydown.escape.window="open = false" x-show="open" x-transition:enter="wr wh wa fe" x-transition:enter-start="opacity-0 aw"
                                    x-transition:enter-end="bv ax" x-transition:leave="wr wh wa" x-transition:leave-start="bv"
                                    x-transition:leave-end="opacity-0" x-cloak="">
                                    <div class="gk text-sm ys" x-ref="options">
                                        <button tabindex="0" class="flex items-center oq xo mt me fn" :class="selected === 0 &amp;&amp; 'text-indigo-500'"
                                            @click="selected = 0;open = false" @focus="open = true" @focusout="open = false">
                                            <svg class="ap mr-2 db text-indigo-500" :class="selected !== 0 &amp;&amp; 'invisible'"
                                                width="12" height="9" viewBox="0 0 12 9">
                                                <path d="M10.28.28L3.989 6.575 1.695 4.28A1 1 0 00.28 5.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28.28z"></path>
                                            </svg>
                                            <span>Today</span>
                                        </button>
                                        <button tabindex="0" class="flex items-center oq xo mt me fn" :class="selected === 1 &amp;&amp; 'text-indigo-500'"
                                            @click="selected = 1;open = false" @focus="open = true" @focusout="open = false">
                                            <svg class="ap mr-2 db text-indigo-500" :class="selected !== 1 &amp;&amp; 'invisible'"
                                                width="12" height="9" viewBox="0 0 12 9">
                                                <path d="M10.28.28L3.989 6.575 1.695 4.28A1 1 0 00.28 5.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28.28z"></path>
                                            </svg>
                                            <span>Last 7 Days</span>
                                        </button>
                                        <button tabindex="0" class="flex items-center oq xo mt me fn" :class="selected === 2 &amp;&amp; 'text-indigo-500'"
                                            @click="selected = 2;open = false" @focus="open = true" @focusout="open = false">
                                            <svg class="ap mr-2 db text-indigo-500" :class="selected !== 2 &amp;&amp; 'invisible'"
                                                width="12" height="9" viewBox="0 0 12 9">
                                                <path d="M10.28.28L3.989 6.575 1.695 4.28A1 1 0 00.28 5.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28.28z"></path>
                                            </svg>
                                            <span>Last Month</span>
                                        </button>
                                        <button tabindex="0" class="flex items-center oq xo mt me fn" :class="selected === 3 &amp;&amp; 'text-indigo-500'"
                                            @click="selected = 3;open = false" @focus="open = true" @focusout="open = false">
                                            <svg class="ap mr-2 db text-indigo-500" :class="selected !== 3 &amp;&amp; 'invisible'"
                                                width="12" height="9" viewBox="0 0 12 9">
                                                <path d="M10.28.28L3.989 6.575 1.695 4.28A1 1 0 00.28 5.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28.28z"></path>
                                            </svg>
                                            <span>Last 12 Months</span>
                                        </button>
                                        <button tabindex="0" class="flex items-center oq xo mt me fn" :class="selected === 4 &amp;&amp; 'text-indigo-500'"
                                            @click="selected = 4;open = false" @focus="open = true" @focusout="open = false">
                                            <svg class="ap mr-2 db text-indigo-500" :class="selected !== 4 &amp;&amp; 'invisible'"
                                                width="12" height="9" viewBox="0 0 12 9">
                                                <path d="M10.28.28L3.989 6.575 1.695 4.28A1 1 0 00.28 5.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28.28z"></path>
                                            </svg>
                                            <span>All Time</span>
                            ...
                            <button class="btn hb xs yo">
                                ...
                                <span class="hidden tro r_">Add Customer</span>
                            </button>
                        </div>
                                ...
                                <table class="av oq lg lb">
                                    <thead class="gb gq text-slate-500 hq ck border-slate-200">
                                        <tr>
                                            ...
                                            <th class="v_ wk xe vm co">
                                                <div class="g_ gh">Tracking ID</div>
                                            </th>
                                            <!-- <th class="v_ wk xe vm co">
                                    ...
                                    <ul class="mf iu" :class="!open &amp;&amp; 'hidden'" x-cloak="">
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" :class="page === 'dashboard-main' &amp;&amp; '!text-indigo-500'"
                                                href="dashboard">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Product Management</span>
                                            </a> -->
                                        <!-- </li>
                                        <li class="rx wj">
                                ...
                                <a class="block ya xw ci wr wu" :class="page.startsWith('ecommerce-') &amp;&amp; 'hover--text-slate-200'"
                                    ...
                                    <div class="flex items-center fg">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm gk ml-3 ttl ttb 2xl:opacity--100 wf">Make Payment</span>
                                        </div>
                                        <div class="flex ap r_ ttl ttb 2xl:opacity--100 wf">
                                            <svg class="w-3 h-3 ap rq db yu" :class="open &amp;&amp; 'fe az'" viewBox="0 0 12 12">
                                                <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z"></path>
