            ...
            <main>
                <div class="vd jd tto vv oq ar ri">
                    ...
                    <div class="td py va jp rounded-sm lq ry">
                        ...
                        <div class="td">
                            <h1 class="gg zj text-slate-800 font-bold rx">Good afternoon, <?php echo @$_SESSION['admin_name']?>👋</h1>
                    ...
                    <div class="_y js jn ry">
                        <ul class="flex flex-wrap justify-center jr ry _a lf si">
                            <li>
                                <a class="block" href="#0">
                                    <img class="uo oa rounded-full" src="images/user-36-01.jpg" width="36" height="36" alt="User 01"> </a>
                            </li>
                            <li>
                                <a class="block" href="#0">
                                    <img class="uo oa rounded-full" src="images/user-36-02.jpg" width="36" height="36" alt="User 02"> </a>
                            </li>
                            <li>
                                <a class="block" href="#0">
                                    <img class="uo oa rounded-full" src="images/user-36-03.jpg" width="36" height="36" alt="User 03"> </a>
                            </li>
                            <li>
                                <a class="block" href="#0">
                                    <img class="uo oa rounded-full" src="images/user-36-04.jpg" width="36" height="36" alt="User 04"> </a>
                            </li>
                            <li>
                        ...
                        <div class="sq fa _j fm ji fy">
                                ...
                                <div class="am nv tp tq tb tg jz qe uq bg-white border border-slate-200 mp rounded by lq iu"
                                    ...
                                    <ul class="rw">
                                        <li class="mt me">
                                            <label class="flex items-center">
                                                ...
                                                <span class="text-sm gk r_">Direct VS Indirect</span>
                                            </label>
                                        </li>
                                        <li class="mt me">
                                            <label class="flex items-center">
                                                <input type="checkbox" class="to" checked="checked">
                                                <span class="text-sm gk r_">Real Time Value</span>
                                            </label>
                                        </li>
                                        <li class="mt me">
                                            <label class="flex items-center">
                                                <input type="checkbox" class="to" checked="checked">
                                                <span class="text-sm gk r_">Top Channels</span>
                                            </label>
                                        </li>
                                        <li class="mt me">
                                            <label class="flex items-center">
                                                <input type="checkbox" class="to">
                                                <span class="text-sm gk r_">Sales VS Refunds</span>
                                            </label>
                                        </li>
                                        <li class="mt me">
                                            <label class="flex items-center">
                                                <input type="checkbox" class="to">
                                                <span class="text-sm gk r_">Last Order</span>
                                            </label>
                                        </li>
                                        <li class="mt me">
                                            <label class="flex items-center">
                                                <input type="checkbox" class="to">
                                                <span class="text-sm gk r_">Total Spent</span>
                                            </label>
                                        </li>
                                    </ul>
                                    <div class="vg me ck border-slate-200 hq">
                                        <ul class="flex items-center fg">
                                            ...
                                            <li>
                                                <button class="btn-xs hb xs yo" @click="open = false" @focusout="open = false">Apply</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="td">
                                <input class="datepicker tn mf text-slate-500 hover--text-slate-600 gk kn oz" placeholder="Select dates"
                        ...
                        <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
                            <div class="mn gn">
                                <header class="flex fg fd in">
                                    ...
                                    <div class="td inline-flex" x-data="{ open: false }">
                                        <button class="yu xm rounded-full" :class="{ 'hy text-slate-500': open }" aria-haspopup="true"
                                        ...
                                        <div class="am nv tp tq tw ae bg-white border border-slate-200 ms rounded by lq iu"
                                            ...
                                            x-transition:enter="wr wh wf fe" x-transition:enter-start="opacity-0 aw" x-transition:enter-end="bv ax"
                                            x-transition:leave="wr wh wf" x-transition:leave-start="bv" x-transition:leave-end="opacity-0"
                                            x-cloak="">
                                            <ul>
                                                <li>
                                                    <a class="gk text-sm ys xy flex mt me" href="#0" @click="open = false" @focus="open = true"
                                                ...
                                                <li>
                                                    <a class="gk text-sm yl xb flex mt me" href="#0" @click="open = false" @focus="open = true"
                        ...
                        <div class="flex fh nk _s bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp flex items-center">
                                ...
                                <div class="td r_" x-data="{ open: false }" @mouseenter="open = true"
                                    ...
                                    <button class="block" aria-haspopup="true" :aria-expanded="open" @focus="open = true" @focusout="open = false"
                                        @click.prevent="">
                                    ...
                                    <div class="nv tp tz ne fe ag">
                                        <div class="bg-white border border-slate-200 vf rounded by lq in" x-show="open" x-transition:enter="wr wh wf fe"
                                            x-transition:enter-start="opacity-0 ak" x-transition:enter-end="bv ax" x-transition:leave="wr wh wf"
                                            x-transition:leave-start="bv" x-transition:leave-end="opacity-0" x-cloak="">
                                            <div class="gb gp co">Built with
                                                <a class="bu" @focus="open = true" @focusout="open = false" href="https://www.chartjs.org/"
                            ...
                            <div class="mn vm">
                                <div class="flex fd">
                                    <div class="text-3xl font-bold text-slate-800 mr-2 ye">$
                                        <span id="dashboard-card-05-value">57.81</span>
                                    </div>
                                                ...
                                                <td class="vc">
                                                    <div class="flex items-center">
                                                        <svg class="ap mr-2 _f" width="36" height="36" viewBox="0 0 36 36">
                                                            ...
                                                            <path d="M26 14.3c-.1 1.6-1.2 3.7-3.3 6.4-2.2 2.8-4 4.2-5.5 4.2-.9 0-1.7-.9-2.4-2.6C14 19.9 13.4 15 12 15c-.1 0-.5.3-1.2.8l-.8-1c.8-.7 3.5-3.4 4.7-3.5 1.2-.1 2 .7 2.3 2.5.3 2 .8 6.1 1.8 6.1.9 0 2.5-3.4 2.6-4 .1-.9-.3-1.9-2.3-1.1.8-2.6 2.3-3.8 4.5-3.8 1.7.1 2.5 1.2 2.4 3.3z"
                                                                fill="#FFF" fill-rule="nonzero"></path>
                                                        </svg>
                                                ...
                                                <td class="vc">
                                                    <div class="flex items-center">
                                                        <svg class="ap mr-2 _f" width="36" height="36" viewBox="0 0 36 36">
                                                            ...
                                                            <path d="M14.232 12.818V23H11.77V12.818h2.46zM15.772 23V12.818h2.462v4.087h4.012v-4.087h2.456V23h-2.456v-4.092h-4.012V23h-2.461z"
                                                                fill="#E6ECF4"></path>
                                                        </svg>
                        ...
                        <!-- <div class="flex fh nk _s bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp flex items-center">
                                ...
                                <div class="td r_" x-data="{ open: false }" @mouseenter="open = true"
                                    ...
                                    <div class="nv tp tz ne fe ag">
                                        <div class="at bg-white border border-slate-200 vf rounded by lq in" x-show="open" x-transition:enter="wr wh wf fe"
                                            x-transition:enter-start="opacity-0 ak" x-transition:enter-end="bv ax" x-transition:leave="wr wh wf"
                                            x-transition:leave-start="bv" x-transition:leave-end="opacity-0" x-cloak="">
                                ...
                                <div>
                                    ...
                                    <ul class="rp">
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">Nick Mark</a> mentioned
                                                        <a class="gk text-slate-800" href="#0">Sara Smith</a> in a new post</div>
                                                    <div class="ap lk r_">
                                                        <a class="gk text-indigo-500 xd" href="#0">View
                                                            <span class="hidden _g"> -&gt;</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">The post
                                                        <a class="gk text-slate-800" href="#0">Post Name</a> was removed by
                                                        <a class="gk text-slate-800 xk" href="#0">Nick Mark</a>
                                                    </div>
                                                    <div class="ap lk r_">
                                                        <a class="gk text-indigo-500 xd" href="#0">View
                                                            <span class="hidden _g"> -&gt;</span>
                                        ...
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">Patrick Sullivan</a> published a new
                                                        <a class="gk text-slate-800"
                                                            href="#0">post</a>
                                                    </div>
                                                    <div class="ap lk r_">
                                                        <a class="gk text-indigo-500 xd" href="#0">View
                                    ...
                                    <ul class="rp">
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">240+</a> users have subscribed to
                                                        <a class="gk text-slate-800" href="#0">Newsletter #1</a>
                                                    </div>
                                                    <div class="ap lk r_">
                                                        <a class="gk text-indigo-500 xd" href="#0">View
                                                            <span class="hidden _g"> -&gt;</span>
                                        ...
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">The post
                                                        <a class="gk text-slate-800" href="#0">Post Name</a> was suspended by
                                                        <a class="gk text-slate-800 xk" href="#0">Nick Mark</a>
                                                    </div>
                                                    <div class="ap lk r_">
                                                        <a class="gk text-indigo-500 xd" href="#0">View
                                    ...
                                    <ul class="rp">
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">Qonto</a> billing</div>
                                                    <div class="ap lx r_">
                                                        <span class="gk text-slate-800">-$49.88</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">Cruip.com</a> Market Ltd 70 Wilson St London</div>
                                                    <div class="ap lx r_">
                                                        <span class="gk yg">+249.88</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">Notion Labs Inc</a>
                                                    </div>
                                                    <div class="ap lx r_">
                                                        <span class="gk yg">+99.99</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">Market Cap Ltd</a>
                                                    </div>
                                                    <div class="ap lx r_">
                                                        <span class="gk yg">+1,200.88</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="flex v_">
                                            ...
                                            <div class="ad flex items-center cx hp text-sm vg">
                                                <div class="ad flex fg">
                                                    <div class="l_">
                                                        <a class="gk text-slate-800 xk" href="#0">App.com</a> Market Ltd 70 Wilson St London</div>
                                                    <div class="ap lx r_">
                                                        <span class="gk text-slate-800 ba">+$99.99</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
