                                ...
                                <section>
                                    ...
                                    <div class="flex flex-wrap ig">
                                        ...
                                        <!-- <div class="_y jn ln ju jl ig"> 
                                           ...
                                           <div class="_x">
                                                <label class="block text-sm gk rx" for="name">Business Name</label>
                                                <input id="name" class="tn oq" type="text" name = "bussnme" placeholder ="Business Name">
                                            </div>
                                            
                                            <div class="_x">
                                                <label class="block text-sm gk rx" for="location">House Address</label>
                                                <input id="location" class="tn oq" type="text" name = "house" placeholder ="House Address">
                                            </div>

                                    <div class="_x">
                                                <label class="block text-sm gk rx" for="location">State</label>
                                                <input id="location" class="tn oq" type="text" name="state" placeholder ="State">
                                
                                        </div>
                                        <div class="_x">
                                                <label class="block text-sm gk rx" for="location">Phone Number</label>
                                                <input id="location" class="tn oq" name="fone" type="text" placeholder = "+234000000">
...
// settings()
    ?> 
          <!-- <div class="_y jn ln ju jl ig">
                                        ...
                                        <div class="_x">
                                            <label class="block text-sm gk rx" for="name">Business Name</label>
                                            <input id="name" class="tn oq" type="text" name = "bussnme" placeholder ="Business Name" value="<?php 
                                            //  echo settings('Business name') 
                                             ?> ">
                                        </div>
                                        
                                        <div class="_x">
                                            <label class="block text-sm gk rx" for="location">House Address</label>
                                            <input id="location" class="tn oq" type="text" name = "house" value="<?php 
                                            //  echo settings('House Address') 
                                             ?>" placeholder ="House Address">
                                        </div>
                       
                                <div class="_x">
                                            <label class="block text-sm gk rx" for="location">State</label>
                                            <input id="location" class="tn oq" type="text" name="state" value="<?php 
                                            //  echo settings('State')
                                             ?>" placeholder ="State">
                                    ...
                                    <div class="_x">
                                    <label class="block text-sm gk rx" for="location">City/Town</label>
                                    <input id="location" class="tn oq" type="text" name="city" value="<?php 
                                    //  echo settings('City')
                                    ...
                                    <div class="_x">
                                            <label class="block text-sm gk rx" for="location">Phone Number</label>
                                            <input id="location" class="tn oq" name="fone" type="text" value="<?php
                                 ...
                                 <div class="_y jn ln ju jl ig">
                                    ...
                                    <div class="_x">
                                            <label class="block text-sm gk rx" for="location">Email</label>
                                            <input id="location" class="tn oq" name="email" type="email" value="<?php  
                                            // echo settings('email')
                                    ...
                                    <div class="_x">
                                            <label class="block text-sm gk rx" for="business-id">Company Address</label>
                                            <input id="business-id" class="tn oq" type="text" name ="cmpnme" value="<?php 
                                            //  echo settings('Company Adress') 
                                ...
                                <!-- <section>
                                    ...
                                    <div class="flex flex-wrap ig">
                                        <div class="mr-2">
                                            <label class="tc" for="email">Business email</label>
                                            <input id="email" class="tn" type="email" disabled value="<?php  
                                            // echo settings('email')
                                             ?>" placeholder="You can change your email">
                                        </div>
