...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from preview.cruip.com/mosaic/index by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Apr 2022 11:07:53 GMT -->
...
<body class="gm bf hy ys" :class="{ 'sidebar-expanded': sidebarExpanded }" x-data="{ page: 'dashboard-main', sidebarOpen: false, sidebarExpanded: localStorage.getItem('sidebar-expanded') == 'true' }"
                                ...
                                <a class="block ya xw ci wr wu" :class="page.startsWith('dashboard-') &amp;&amp; 'hover--text-slate-200'"
                                    ...
                                    <div class="flex items-center fg">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm gk ml-3 ttl ttb 2xl:opacity--100 wf">Product management</span>
                                        </div>
                                    ...
                                    <ul class="mf iu" :class="!open &amp;&amp; 'hidden'" x-cloak="">
                                        <!-- <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" :class="page === 'dashboard-main' &amp;&amp; '!text-indigo-500'"
                                                href="addproduct">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Add Product</span>
                                            </a>
                                        </li>
                                       -->
                                        <!-- <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" :class="page === 'dashboard-fintech' &amp;&amp; '!text-indigo-500'"
                                                href="orders">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Ordered Product</span>
                                            </a>
                                        </li> --> 
                                        <!-- <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" :class="page === 'dashboard-fintech' &amp;&amp; '!text-indigo-500'"
                                                href="">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Deliver Product</span>
                                            </a>
                                        <li>
                        ...
                        <div class="flex items-center lu">
                            ...
                            <div class="td inline-flex" x-data="{ open: false }">
                                ...
                                <div class="am nv tp tq tw uj bg-white border border-slate-200 ms rounded by lq iu" @click.outside="open = false"
                                    ...
                                    <ul>
                                        <li>
                                            <a class="gk text-sm text-indigo-500 xd flex items-center mt me" href="user_settings"
...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from preview.cruip.com/mosaic/user_settings by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Apr 2022 11:20:33 GMT -->
                        ...
                        <div class="flex items-center lu">
                            ...
                            <div class="td inline-flex" x-data="{ open: false }">
                                <button class="inline-flex justify-center items-center kp" aria-haspopup="true" @click.prevent="open = !open"
                                    ...
                                    <img class="uu of rounded-full" src="images/user-avatar-32.png" width="32" height="32" alt="User">
                                    <div class="flex items-center ci">
                                        <span class="ci r_ text-sm gk km"><?php echo@ $_SESSION['user']?></span>
                                        <svg class="w-3 h-3 ap rq db yu" viewBox="0 0 12 12">
                                            <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z"></path>
                                        </svg>
                                    </div>
                                ...
                                <div class="am nv tp tq tw uj bg-white border border-slate-200 ms rounded by lq iu" @click.outside="open = false"
                                    ...
                                    x-transition:leave-end="opacity-0" x-cloak="">
                                    <div class="mm mv me rx cx border-slate-200">
                                        <div class="gk text-slate-800"><?php echo @$_SESSION['email']?></div>
                                        <div class="gb text-slate-500 gz"><?php echo @$_SESSION['user']?></div>
                                    </div>
                                    <ul>
                                        <li>
                                            <a class="gk text-sm text-indigo-500 xd flex items-center mt me" href="user_settings"
                                        ...
                                        <li>
                                            <form action="" method="post"><?php  signout()?>
                                            <button type="submit" name="signout" class="gk text-sm text-indigo-500 xd flex items-center mt me"
                                                @click="open = false" @focus="open = true" @focusout="open = false">Sign Out</button>
                                                </form>
                                        </li>
                    ...
                    <div class="bg-white by rounded-sm ry">
                        ...
                        <svg width="32" height="32" viewBox="0 0 32 32">
                            ...
                            <div class="flex fp cn ta qh zp me mu cx zm zg border-slate-200 uz zh">
                                <div>
                                    <div class="gb g_ yu gq it">My Dashboard</div>
                                    <ul class="flex fp qh rk ql">
                                            ...
                                            <a class="flex items-center vk vg rounded co" :class="settingsPanel === 'apps' &amp;&amp; 'ph'"
                                                ...
                                                <span class="text-sm gk ys" :class="settingsPanel === 'apps' ? 'text-indigo-500' : 'xx'">Home</span>
                                            </a>
                                        </li>
                                             <li class="sa ql qc">
                                            <a class="flex items-center vk vg rounded co" :class="settingsPanel === 'notifications' &amp;&amp; 'ph'"
                                                ...
                                                <span class="text-sm gk ys" :class="settingsPanel === 'notifications' ? 'text-indigo-500' : 'xx'">Dashboard</span>
                                            </a>
                                        </li>
                                    <li class="sa ql qc">
                                            <a class="flex items-center vk vg rounded co" :class="settingsPanel === 'account' &amp;&amp; 'ph'"
                                                ...
                                                <span class="text-sm gk ys" :class="settingsPanel === 'account' ? 'text-indigo-500' : 'xx'">Ordered Products</span>
                                            </a>
                                        </li>
                                        <li class="sa ql qc">
                                            <a class="flex items-center vk vg rounded co" :class="settingsPanel === 'account' &amp;&amp; 'ph'"
