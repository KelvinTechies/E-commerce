                            ...
                            <div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                        <div>
                                            ...
                                            <input id="default" class="tn oq" type="text" name="productname">
                                        </div>
                                        <!-- End -->
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <input id="tooltip" class="tn oq" type="text" name="productbrand">
                                        </div>
                                        <!-- End -->
                                    </div>

                                                                            <div>
                                            <label class="block text-sm gk rx" for="default">Product Mileage</label>
                                            <input id="default" class="tn oq" type="text" name="productmileage">
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <!-- <div>
                                            ...
                                            <div class="td">
                                                <input id="prefix" class="tn oq my" type="number" name="productprice"> 
                                        ...
                                        <div>
                                            ...
                                            <div class="td">
                                                <input id="suffix" class="tn oq mb" type="date" name="dateofupload">
                                        ...
                                        <div>
                                            ...
                                            <!-- <select name="productyear" id="" class="tn oq" >
                                            <option value="" class="tn oq" selected>--Select Year--</option> -->
                                             <?php
                                                // year();
                                               ?>
                                            <!-- </select> -->
                                            <input id="mandatory" class="tn oq" name="productyear" type="number">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <input id="placeholder" class="tn oq" type="file" name="files[]" multiple>
                                        </div>
                                        <!-- End -->
                                    </div>
                                    ...
                                    <div>
                                            ...
                                            <textarea name="productdescription" id="toolclip" class="tn oq my cols"="30" rows="5"></textarea>                                      
                                          </div>
                                          <div>
                                        <!-- Start -->
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div class="td">
                                            <button type="submit" class="btn hk xf yo tn oq" name="add">Add Product</button>
                                            </div>
                                            </div>
                                        </div>
                                        <!-- End -->
