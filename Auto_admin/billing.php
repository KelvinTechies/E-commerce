...
?>
                                ...
                                <div class="vs fz">
                                    <div>
                                        <h2 class="gg text-slate-800 font-bold rw">Billing &amp; Invoices</h2>
                                        <div class="text-sm">This workspace’s Basic Plan is set to
                                            <strong class="gk">$34</strong> per month and will renew on
                                            <strong class="gk">July 9, 2021</strong>.</div>
                                    </div>

                                    <!-- Billing Information -->
                                    <section>
                                        <h3 class="gy yt text-slate-800 font-bold rx">Billing Information</h3>
                                        <ul>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">Full Name</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo @$_SESSION['user']?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">Bussiness Name</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('Business name') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">VAT/GST Number</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('Phone number') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">Your Address</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('House Address') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">Company Address</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('Company Adress') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">State</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('State') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">City/Town</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('City') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">Email</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('email') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                            <li class="qd zo zr vm cx border-slate-200">
                                                <!-- Left -->
                                                <div class="text-sm text-slate-800 gk">Country</div>
                                                <!-- Right -->
                                                <div class="text-sm text-slate-800ml-4">
                                                    <span class="rk"><?php echo Billing('Country') ?></span>
                                                    <a class="gk text-indigo-500 xd" href="user_settings">Edit</a>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <!-- Invoices -->
                                    <section>
                                        <h3 class="gy yt text-slate-800 font-bold rx">Invoices</h3>
                                        <!-- Table -->
                                        <table class="av oq">
                                            <!-- Table header -->
                                            <thead class="gb gq yu">
                                                <tr class="flex flex-wrap qm md:flex-no-wrap">
                                                    <th class="oq block qb qv vg">
                                                        <div class="g_ gh">Year</div>
                                                    </th>
                                                    <th class="oq hidden qb qv vg">
                                                        <div class="g_ gh">Plan</div>
                                                    </th>
                                                    <th class="oq hidden qb qv vg">
                                                        <div class="g_ gh">Amount</div>
                                                    </th>
                                                    <th class="oq hidden qb qv vg">
                                                        <div class="g_ gd"></div>
                                                    </th>
                                            ...
                                            <tbody class="text-sm">
                                                ...
                                                <tr class="flex flex-wrap qm md:flex-no-wrap cx border-slate-200 vg zy">
                                                    <td class="oq block qb qv vy zb">
                                                        <div class="gh gk text-slate-800">2021</div>
                                                    </td>
                                                    <td class="oq block qb qv vy zb">
                                                        <div class="gh">Basic Plan - Annualy</div>
                                                    </td>
                                                    <td class="oq block qb qv vy zb">
                                                        <div class="gh gk">$349.00</div>
                                                    </td>
                                                    <td class="oq block qb qv vy zb">
                                                ...
                                                <tr class="flex flex-wrap qm md:flex-no-wrap cx border-slate-200 vg zy">
                                                    <td class="oq block qb qv vy zb">
                                                        <div class="gh gk text-slate-800">2020</div>
                                                    </td>
                                                    <td class="oq block qb qv vy zb">
                                                        <div class="gh">Basic Plan - Annualy</div>
                                                    </td>
                                ...
                                <footer>
                                    <!-- <div class="flex fh vw vx ck border-slate-200">
                                        <div class="flex lk">
                                            <button class="btn border-slate-200 hover--border-slate-300 ys">Cancel</button>
                                            <button class="btn hb xs yo ml-3" name="btn">Save Changes</button>
                                        </div>
                                    </div> -->
                                    </form>
                                </footer>
...
<!-- <!DOCTYPE html>
<html lang="en"> -->
<!-- Mirrored from preview.cruip.com/mosaic/billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Apr 2022 11:20:33 GMT -->

<!-- <head>
    <meta charset="utf-8">
    <title>Mosaic HTML Demo - Billing &amp; Invoices</title>
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <link href="style.a49749f4fb5cff923e10.css" rel="stylesheet">
</head>

<body class="gm bf hy ys" :class="{ 'sidebar-expanded': sidebarExpanded }" x-data="{ page: 'settings-billing', settingsPanel: 'billing', sidebarOpen: false, sidebarExpanded: localStorage.getItem('sidebar-expanded') == 'true' }"
                            ...
                            <li class="me vg rounded-sm ib wj" :class="{ 'bg-slate-900': page.startsWith('ecommerce-') }"
                                ...
                                <div class="tec ttd 2xl:block">
                                    <ul class="mf iu" :class="!open &amp;&amp; 'hidden'" x-cloak="">
                                        ...
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="pay.html">
                        ...
                        <ul class="im">
                            <li class="me vg rounded-sm ib wj" x-data="{ open: false }">
                                ...
                                <div class="tec ttd 2xl:block">
                                    <ul class="mf iu" :class="{ 'hidden': !open }" x-cloak="">
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="signin.html">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Sign In</span>
                                            </a>
                                        </li>
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="signup.html">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Sign up</span>
                                            </a>
                                        </li>
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="reset-password.html">
                            ...
                            <li class="me vg rounded-sm ib wj" x-data="{ open: false }">
                                ...
                                <div class="tec ttd 2xl:block">
                                    <ul class="mf iu" :class="{ 'hidden': !open }" x-cloak="">
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="onboarding-01.html">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Step 1</span>
                                            </a>
                                        </li>
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="onboarding-02.html">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Step 2</span>
                                            </a>
                                        </li>
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="onboarding-03.html">
                                                <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Step 3</span>
                                            </a>
                                        </li>
                                        <li class="rx wj">
                                            <a class="block yu hover--text-slate-200 wr wu ci" href="onboarding-04.html">
                        ...
                        <div class="flex items-center lu">
                            ...
                            <div class="td inline-flex" x-data="{ open: false }">
                                ...
                                <div class="am nv tp tq tw uj bg-white border border-slate-200 ms rounded by lq iu" @click.outside="open = false"
                                    ...
                                    <ul>
                                        <li>
                                            <a class="gk text-sm text-indigo-500 xd flex items-center mt me" href="settings.html"
                                                @click="open = false" @focus="open = true" @focusout="open = false">Settings</a>
                                        </li>
                                        <li>
                                            <a class="gk text-sm text-indigo-500 xd flex items-center mt me" href="signin.html"
