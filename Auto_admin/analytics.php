<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from preview.cruip.com/mosaic/analytics by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Apr 2022 11:12:42 GMT -->
...
<body class="gm bf hy ys" :class="{ 'sidebar-expanded': sidebarExpanded }" x-data="{ page: 'dashboard-analytics', sidebarOpen: false, sidebarExpanded: localStorage.getItem('sidebar-expanded') == 'true' }"
                            ...
                            <div class="td inline-flex" x-data="{ open: false }">
                                ...
                                <div class="am nv tp tq tw uj bg-white border border-slate-200 ms rounded by lq iu" @click.outside="open = false"
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="gk text-sm text-indigo-500 xd flex items-center mt me" href="signin"
            ...
            <main>
                <div class="vd jd tto vv oq ar ri">
                    ...
                    <div class="_y js jn ry">
                        ...
                        <!-- Left: Title -->
                        <div class="rw _a">
                            <h1 class="gg zj text-slate-800 font-bold">Analytics ✨</h1>
                        </div>
                    ...
                    <div class="sq ff fb">
                        ...
                        <div class="flex fh nk tt_ bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp flex items-center">
                                <h2 class="g_ text-slate-800">Analytics</h2>
                            </header>
                            <div class="mn mt">
                                <div class="flex flex-wrap">
                                    <div class="flex items-center vg">
                                        <div class="iy">
                                            <div class="flex items-center">
                                                <div class="text-3xl font-bold text-slate-800 mr-2">24.7K</div>
                                                <div class="text-sm gk yg">+49%</div>
                                            </div>
                                            <div class="text-sm text-slate-500">Unique Visitors</div>
                                        </div>
                                        <div class="hidden qh ut of hw iy" aria-hidden="true"></div>
                                    </div>
                                    <div class="flex items-center vg">
                                        <div class="iy">
                                            <div class="flex items-center">
                                                <div class="text-3xl font-bold text-slate-800 mr-2">56.9K</div>
                                                <div class="text-sm gk yg">+7%</div>
                                            </div>
                        ...
                        <div class="flex fh nk ttk bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Active Users Right Now</h2>
                            </header>
                            <div class="flex fh or">
                                <div class="mn vm">
                                    <div class="flex items-center">
                                        <div class="td flex items-center justify-center ue on rounded-full pt rk" aria-hidden="true">
                                            <div class="tp ub ob rounded-full pr"></div>
                                        </div>
                                        <div>
                                ...
                                <div class="ad mn gi mx">
                                    <div class="lz">
                                        <table class="av oq">
                                            <thead class="gb gq yu">
                                                <tr>
                                                    <th class="vg">
                                                        <div class="g_ gh">Top pages</div>
                                                    </th>
                                                    <th class="vg">
                                                        <div class="g_ gd">Active users</div>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody class="text-sm lg lw">
                                                <tr>
                                                    <td class="vg">
                                                        <div class="gh">preview.cruip.com/open-pro/</div>
                                                    </td>
                                                    <td class="vg">
                                                        <div class="gk gd text-slate-800">94</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="vg">
                                                        <div class="gh">preview.cruip.com/simple/</div>
                                                    </td>
                                                    <td class="vg">
                                                        <div class="gk gd text-slate-800">42</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="vg">
                                                        <div class="gh">cruip.com/unlimited/</div>
                                                    </td>
                                                    <td class="vg">
                                                        <div class="gk gd text-slate-800">12</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="vg">
                                                        <div class="gh">preview.cruip.com/twist/</div>
                                                    </td>
                                                    <td class="vg">
                                                        <div class="gk gd text-slate-800">4</div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="gd mn mj">
                                    <a class="text-sm gk text-indigo-500 xd" href="#0">Real-Time Report -&gt;</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex fh nk _s bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp flex items-center">
                                <h2 class="g_ text-slate-800">Acquisition Channels</h2>
                            </header>
                            <div class="mn mr">
                                <div id="analytics-card-03-legend" class="ad rx">
                        ...
                        <div class="flex fh nk _s bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Audience Overview</h2>
                            </header>
                            <div id="analytics-card-04-legend" class="mn mr">
                                <ul class="flex flex-wrap"></ul>
                            </div>
                            <div class="ad">
                        ...
                        <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
                            ...
                            <div class="ad vf">
                                <div class="flex fh or">
                                    <div class="ad">
                                        <ul class="flex fg gb gq yu g_ v_ lt">
                                            <li>Source</li>
                                            <li>Visitors</li>
                                        </ul>
                                        <ul class="lo text-sm text-slate-800 im rw">
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:82%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Google</div>
                                                    <div class="gk">4.7K</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:70%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Indiehackers.com</div>
                                                    <div class="gk">4.2K</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:60%"></div>
                                                <div class="td flex fg lt">
                                                    <div>DuckDuckGo</div>
                                                    <div class="gk">3.4K</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:44%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Hacker News</div>
                                                    <div class="gk">3.1K</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:40%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Github.com</div>
                                                    <div class="gk">2.2K</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:30%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Madewithvuejs.com</div>
                                                    <div class="gk">1.7K</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:22%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Producthunt.com</div>
                                                    <div class="gk">924</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pi" aria-hidden="true" style="width:12%"></div>
                                                <div class="td flex fg lt">
                                                    <div>Dev.to</div>
                                                    <div class="gk">696</div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="gp mw mx ck hp">
                                        <a class="text-sm gk text-indigo-500 xd" href="#0">Channels Report -&gt;</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Top Pages</h2>
                            </header>
                            <div class="ad vf">
                                <div class="flex fh or">
                                    <div class="ad">
                                    ...
                                    <div class="gp mw mx ck hp">
                                        <a class="text-sm gk text-indigo-500 xd" href="#0">Page Report -&gt;</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ad vf">
                                <div class="flex fh or">
                                    <div class="ad">
                                        ...
                                        <ul class="lo text-sm text-slate-800 im rw">
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:82%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇨🇮 Ireland</div>
                                                    <div class="gk">4.2K</div>
                                                </div>
                                            ...
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:70%"></div>
                                                <div class="td flex fg lt">
                                            ...
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:60%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇩🇪 Germany</div>
                                                    <div class="gk">1.6k</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:44%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇮🇹 Italy</div>
                                                    <div class="gk">1.2k</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:40%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇬🇧 United Kingdom</div>
                                                    <div class="gk">912</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:30%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇫🇷 France</div>
                                                    <div class="gk">677</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:22%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇮🇳 India</div>
                                                    <div class="gk">449</div>
                                                </div>
                                            </li>
                                            <li class="td v_ mt">
                                                <div class="tp tm pn" aria-hidden="true" style="width:12%"></div>
                                                <div class="td flex fg lt">
                                                    <div>🇸🇬 Singapore</div>
                                                    <div class="gk">269</div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="gp mw mx ck hp">
                                        <a class="text-sm gk text-indigo-500 xd" href="#0">Countries Report -&gt;</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Sessions By Device</h2>
                            </header>
                            <div class="ad flex fh justify-center">
                                <div>
                                    <canvas id="analytics-card-08" width="389" height="260"></canvas>
                                </div>
                                <div id="analytics-card-08-legend" class="mn gs mc">
                        ...
                        <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Sessions By Age</h2>
                            </header>
                            <div class="ad flex fh justify-center">
                                <div>
                                    <canvas id="analytics-card-09" width="389" height="260"></canvas>
                                </div>
                                <div id="analytics-card-09-legend" class="mn gs mc">
                                    <ul class="flex flex-wrap justify-center -m-1"></ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Sessions By Gender</h2>
                            </header>
                            <div class="ad flex fh justify-center">
                                <div>
                                    <canvas id="analytics-card-10" width="389" height="260"></canvas>
                                </div>
                                <div id="analytics-card-10-legend" class="mn gs mc">
                                    <ul class="flex flex-wrap justify-center -m-1"></ul>
                                </div>
                            </div>
                        </div>
                        <!-- Table (Top Products) -->
                        <div class="nk bg-white by rounded-sm border border-slate-200">
                            <header class="mn mr cx hp">
                                <h2 class="g_ text-slate-800">Top Products</h2>
                            </header>
                            <div class="vf">
                                <div class="lz">
                                    <table class="av oq">
                                        <thead class="gb gq yu hq rounded-sm">
                                            <tr>
                                                ...
                                                <th class="vc co">
                                                    <div class="g_ gh">Created by</div>
                                                </th>
                                                <th class="vc co">
                                                    <div class="g_ gh">Category</div>
                                                </th>
                                                <th class="vc co">
                                                    <div class="g_ gp">Total impressions</div>
                                                </th>
                                                <th class="vc co">
                                                    <div class="g_ gp">Top country</div>
                                                </th>
                                                <th class="vc co">
                                                    <div class="g_ gp">CR</div>
                                                </th>
                                                <th class="vc co">
                                                    <div class="g_ gh">Value</div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody class="text-sm lg lw">
                                            <tr>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                        <div class="ap rounded-full mr-2 _f hb">
                                                        ...
                                                        <div class="gk text-slate-800">Form Builder CP</div>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex ap lf si">
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-01.jpg" width="28"
                                                                height="28" alt="User 01"> </a>
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-02.jpg" width="28"
                                                                height="28" alt="User 02"> </a>
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-03.jpg" width="28"
                                                                height="28" alt="User 03"> </a>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                ...
                                                <td class="vc co">
                                                    <div class="gp">20,929</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gx gp">🇺🇸</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gp">27.4%</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gh gk yg">$12,499.77</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                        <div class="ap rounded-full mr-2 _f hk">
                                                        ...
                                                        <div class="gk text-slate-800">Machine Learning A-Z</div>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex ap lf si">
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-07.jpg" width="28"
                                                                height="28" alt="User 07"> </a>
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-04.jpg" width="28"
                                                                height="28" alt="User 04"> </a>
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-11.jpg" width="28"
                                                                height="28" alt="User 11"> </a>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                ...
                                                <td class="vc co">
                                                    <div class="gp">17,944</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gx gp">🇬🇧</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gp">22.6%</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gh gk yg">$4,227.09</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="gk text-slate-800">2021 Web Bootcamp</div>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex ap lf si">
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-05.jpg" width="28"
                                                                height="28" alt="User 05"> </a>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                ...
                                                <td class="vc co">
                                                    <div class="gp">16,097</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gx gp">🇫🇷</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gp">22.4%</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gh gk yg">$2,499.77</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                        <div class="ap rounded-full mr-2 _f hx">
                                                            <svg class="uo oa db text-indigo-50" viewBox="0 0 36 36">
                                                                <path d="M18 26a8 8 0 118-8 8.009 8.009 0 01-8 8zm0-14a6 6 0 100 12 6 6 0 000-12z"></path>
                                                            </svg>
                                                        </div>
                                                        <div class="gk text-slate-800">Digital Marketing Course</div>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex ap lf si">
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-06.jpg" width="28"
                                                                height="28" alt="User 06"> </a>
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-11.jpg" width="28"
                                                                height="28" alt="User 11"> </a>
                                                    </div>
                                                ...
                                                <td class="vc co">
                                                    <div class="gp">12,996</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gx gp">🇮🇹</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gp">22.1%</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gh gk yg">$2,224.09</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="vc co">
                                                    <div class="flex items-center">
                                                        <div class="ap rounded-full mr-2 _f pr">
                                                            <svg class="uo oa db text-indigo-50" viewBox="0 0 36 36">
                                                        ...
                                                        <div class="gk text-slate-800">Form Builder PRO</div>
                                                    </div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="flex ap lf si">
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-09.jpg" width="28"
                                                                height="28" alt="User 09"> </a>
                                                        <a class="block" href="#0">
                                                            <img class="rounded-full cy ht sj" src="images/user-28-01.jpg" width="28"
                                                                height="28" alt="User 01"> </a>
                                                    </div>
                                                ...
                                                <td class="vc co">
                                                    <div class="gp">7,097</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gx gp">🇩🇪</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gp">17.4%</div>
                                                </td>
                                                <td class="vc co">
                                                    <div class="gh gk yg">$1,949.72</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
